...
int main() {
    ...
    std::cout << "5A:\t" << AoC_5::AB(AoC_5_Input, AoC_5_Input_A) << "\n";
    std::cout << "5B:\t" << AoC_5::AB(AoC_5_Input, AoC_5_Input_B) << "\n";
    ...
    std::cout << "9A:\t" << AoC_9::AB(AoC_9_Input, AoC_9_Input_A) << "\n";
    std::cout << "9B:\t" << AoC_9::AB(AoC_9_Input, AoC_9_Input_B) << "\n";
}